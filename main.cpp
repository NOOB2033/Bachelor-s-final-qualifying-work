...
void big_test() {
    std::ofstream output("old.txt");
    for (size_t i = 200; i <= 4000; i += 200) {
        output << "Размер: " + std::to_string(i) << std::endl;
        auto start = std::chrono::high_resolution_clock::now();
        std::string str = "FSMS/" + std::to_string(i) + "_10_10.fsm";
